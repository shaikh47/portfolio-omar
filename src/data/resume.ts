...
export const resumeData: ResumeData = {
  ...
  skills: [
    {
      label: 'Frontend',
      skills: ['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'Three.js', 'React Three Fiber', 'Zustand', 'Chart.js'],
    },
    {
      label: 'Backend',
    ...
    {
      label: 'Blockchain',
      skills: ['Ethereum', 'Smart Contracts', 'Web3.js', 'web3j', 'NFT / SBT', 'Solidity'],
    },
    {
      label: 'Database',
  ...
  awards: [
    { date: 'Jan 2020', place: 'Scholarship Participant', event: 'JENESYS 2019, SAARC 2nd Batch', venue: 'Tokyo, Japan' },
    { date: 'Jan 2019', place: '1st Place', event: 'Soccer Bot — BUET Robo Carnival', venue: 'BUET, Bangladesh' },
    { date: 'Jul 2019', place: '2nd Place', event: 'Robo Race — Mecceleration, IUT', venue: 'IUT, Bangladesh' },
    { date: 'Nov 2018', place: '1st Place', event: 'Soccer Bot — IEEE Day, East West University', venue: 'EWU, Bangladesh' },
    { date: 'Oct 2018', place: '1st Place', event: 'Soccer Bot — Mecceleration 18, IUT', venue: 'IUT, Bangladesh' },
    { date: 'Nov 2018', place: '1st Place', event: 'Robo Soccer — Daffodil International University', venue: 'DIU, Bangladesh' },
  ],
}
