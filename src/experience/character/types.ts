...
export type CharacterConfig = {
   ...
   * Receives a track name like `"mixamorigHips.quaternion"` and should return
   * the corrected name (e.g. `"Hips.quaternion"`).
   * Defaults to identity (no remapping) if omitted.
   */
  retargetTrackName?: (trackName: string) => string;
};
